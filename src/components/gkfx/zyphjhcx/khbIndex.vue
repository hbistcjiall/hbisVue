    ...
    <div>
        <div>
            <div style="border:1px solid black;" class="LeftImg">
                <x-chart id="khb_pieValue" :option="pieOption"></x-chart>
            </div>
            <div style="border:1px solid black;" class="RightImg">
                <x-chart id="khb_rcolumnValue"  :option="option"></x-chart>
            </div>
        </div>
        <div>
            <div class="LeftImg">
                <Table border stripe :columns="columns1" :data="resDatas3" style="margin-top: 20px" id="khbTable1">
            ...
            <div class="RightImg">
                <Table border stripe :columns="columns2" :data="resDatas4" style="margin-top: 20px" id="khbTable2">
                    <template slot-scope="{ row }" slot="name">
                        <strong>{{ row.name }}</strong>
                    </template>
                </Table>
