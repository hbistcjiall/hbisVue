    ...
    <div>
        <Form :label-width="80">
            <Row>
                <Col span="4">
                    <FormItem label="钢厂:">
                        <Select v-model="ddlxyjglxdyData.companyId">
                ...
                <Col span="4">
                    <FormItem label="品种:">
                        <Select v-model="ddlxyjglxdyData.varieties">
                            <Option value="">全部</Option>
                ...
                <Col span="4" style="float: left">
                    <FormItem label="订单类型:">
                        <Input v-model="ddlxyjglxdyData.orderType" placeholder="请输入订单类型"></Input>
                    </FormItem>
                </Col>
                <Col span="4">
                    <FormItem label="价格类型:">
                        <Input v-model="ddlxyjglxdyData.priceType" placeholder="请输入价格类型"></Input>
                    </FormItem>
                </Col>
