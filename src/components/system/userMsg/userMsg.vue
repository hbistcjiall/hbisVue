<template>
    <div>
        ...
        <DatePicker type="datetimerange" @on-change="serTime" format="yyyy-MM-dd" placeholder="请选择查询时间"
                    style="width: 300px;margin-right:20px"></DatePicker>
            ...
            <Form :model="updformValidate" :rules="updruleValidate" :label-width="60">
                ...
                <FormItem label="出生日期">
                    <Row>
                        <Col span="11">
                            <FormItem>
                                <DatePicker format="yyyy-MM-dd" type="date" placeholder="出生日期"
                                            v-model="updformValidate.birthday"></DatePicker>
                            </FormItem>
                        </Col>
                    </Row>
                </FormItem>
